...
--
-- Host: 127.0.0.1:3308
-- Creato il: Set 13, 2021 alle 06:54
...
--
-- Struttura della tabella `auteur`
--
...
--
-- Dump dei dati per la tabella `auteur`
--
...
('DoctrineMigrations\\Version20210910075947', '2021-09-10 08:01:44', 49),
('DoctrineMigrations\\Version20210910080423', '2021-09-10 08:04:29', 63);

-- --------------------------------------------------------

--
-- Struttura della tabella `editeur`
--
...
--
-- Dump dei dati per la tabella `editeur`
--
...
--
-- Struttura della tabella `fournisseur`
--
...
--
-- Dump dei dati per la tabella `fournisseur`
--
...
(1, 'anis@anis.com', '[]', 'anis', 'anis'),
(2, 'test@test.com', '[\"ROLE_USER\", \"ROLE_ADMIN\"]', '$2y$13$/xLDa9MC6K19AP9gLvp13.wPB/KkTozMqsY/ZkbyW10V5S8RUj2Qu', 'test');
