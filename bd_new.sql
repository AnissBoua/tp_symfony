...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 08 mars 2021 à 09:05
...
CREATE TABLE IF NOT EXISTS `editeur` (
  `id` int NOT NULL AUTO_INCREMENT,
  `editeur` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `produit` (
  ...
  `ref_bd` varchar(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `heros` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `ref_fournisseur` bigint DEFAULT NULL,
  `ref_editeur` bigint DEFAULT NULL,
